...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<div><b>Drag &amp; Drop Files</b></div>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
            ...
            ajax_drag_drop_class: 'ajax-upload-dragdrop',
        ...
        this.hide();
        this.errorLog = $("<div class='hidden-content'></div>"); //Writing errors
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    var dragDrop = $('<div class="' + s.ajax_drag_drop_class + '" style="vertical-align:top;text-align:center;"></div>');
                    $(obj).before(dragDrop);
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input type='file' class='upload-file-item' id='" + fileUploadId + "' name='" + s.fileName + "'/>";
            if (s.multiple) {
...
*/
           ...
           if (navigator.appVersion.indexOf("MSIE ") != -1) //IE Browser
            {
                ...
                $('.' + s.browse_btn_class).click(function () {
                    fileInput.click();
                });
            }
        }
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='ajax-file-upload-statusbar' style='display:none !important;'></div>");
            this.filename = $("<div class='ajax-file-upload-filename' style='display:none !important;'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress' style='display:none !important;'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='ajax-file-upload-bar " + obj.formGroup + "' style='display:none !important;'></div>").appendTo(this.progressDiv);
            this.abort = $("<div class='ajax-file-upload-red " + obj.formGroup + "' style='display:none !important;'>" + s.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = $("<div class='ajax-file-upload-red' style='display:none !important;'>" + s.cancelStr + "</div>").appendTo(this.statusbar).hide();
            this.done = $("<div class='ajax-file-upload-green' style='display:none !important;'>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
            this.del = $("<div class='ajax-file-upload-red' style='display:none !important;'>" + s.deletelStr + "</div>").appendTo(this.statusbar).hide();
