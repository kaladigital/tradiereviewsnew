                    ...
                    <table width="100%" style="border-spacing: 0; border-spacing: 0; text-align: center;">
                        <tr>
                            <td style="padding: 0; text-align: center;">
                                <a href="{{ $other_parameters['app_url'] }}" style="text-decoration: none; display: block; max-width: 270px; margin-left: auto; margin-right: auto;">
                        ...
                        <tr>
                            <td style="padding: 0; padding-top: 32px; text-align: center;">
                                <h1 style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif; font-size: 30px; line-height: 36px; font-weight: 500;">
                                    <span style="display: inline; color: #3962fa; text-transform: capitalize;">{{ $other_parameters['user_name'] }}</span> asks you to subscribe to <span style="display: inline; color: #3962fa;">TradieReviews</span> so the both of you can get your <span style="display: inline; color: #3962fa;">free month!</span>.
                                </h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0; padding-top: 16px; font-size: 17px; line-height: 24px;">
                                <p style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif;">
                                    TradieReviews helps you quickly generate 100’s of online reviews from authentic customers. If you subscribe to TradieReviews, you and {{ $other_parameters['user_name'] }} will get a 1-month premium subscription for free, and everybody wins!
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0; padding-top: 16px; padding-bottom: 32px; font-size: 17px; line-height: 24px;">
                                <p style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif;">
                                    Subscribe to TradieReviews now on the following link:
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <a href="{{ $other_parameters['app_url'] }}/settings/subscriptions" style="display: block;margin-left: auto;margin-right: auto;font-size: 16px;font-weight: 600;font-family: 'Poppins', sans-serif;text-decoration: none !important;border-radius: 4px;max-width: 258px;image-rendering: -webkit-optimize-contrast;">
                                    <img src="{{ $other_parameters['app_url'] }}/images/subscribe-now.png" alt="Complete sign up" width="258" height="50" />
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 32px; font-size: 17px; line-height: 24px;">
                                <p style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif;">
                                    ...
                                    <a href="mailto:info@tradiereviews.co">
                                        info@tradiereviews.co
                                    </a>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 40px; font-size: 17px; line-height: 24px;">
                                <p style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif; text-align: center;">
                                    Tailored to your needs by Tradie
                                ...
                                <p style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif; text-align: center;">
                                    ...
                                    <a href="{{ $other_parameters['app_url'] }}/free-trial" style="margin-left: 12px; display: inline; vertical-align: middle;">Free Demo</a>
                                </p>
                            </td>
                        </tr>
                    </table>
