                        ...
                        <tr>
                            <td style="padding: 0; padding-top: 32px; text-align: center;">
                                <h1 style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif; font-size: 30px; line-height: 36px; font-weight: 500;">
                                    <span style="display: inline; color: #3962fa; text-transform: capitalize;">{{ $other_parameters['sender_name'] }}</span> asks you to subscribe to <span style="display: inline; color: #3962fa;">TradieReviews</span> so the both of you can get your <span style="display: inline; color: #3962fa;">free month!</span>
                                </h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 0; padding-top: 16px; font-size: 17px; line-height: 24px;">
                                <p style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif;">
                                    TradieReviews helps you quickly generate 100’s of online reviews from authentic customers. If you subscribe to TradieReviews, you and {{ $other_parameters['sender_name'] }} will get a 1-month premium subscription for free, and everybody wins!
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <a href="{{ $other_parameters['app_url'] }}/referrals/{{ $other_parameters['code'] }}" style="display: block;margin-left: auto;margin-right: auto;font-size: 16px;font-weight: 600;font-family: 'Poppins', sans-serif;text-decoration: none !important;border-radius: 4px;max-width: 258px;image-rendering: -webkit-optimize-contrast;">
                                    <img src="{{ $other_parameters['app_url'] }}/images/get-free-month.png" alt="Complete sign up" width="258" height="50" />
                                </a>
                            </td>
                        </tr>
                        <tr>
