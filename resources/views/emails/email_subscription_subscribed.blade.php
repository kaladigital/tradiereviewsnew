...
<head>
    ...
    <title>TradieReviews Newsletter Email</title>
                        ...
                        <tr>
                            <td style="padding:0;text-align: center;">
                                <a href="{{ $other_parameters['app_url'] }}"
                                   style="text-decoration:none;display:block; margin-left: auto; margin-right: auto; max-width: 275px;">
                                    <img src="{{ $other_parameters['app_url'] }}/images/logo.png"
                                         alt="TradieReviews logo" width="274.5" height="24" style="border:0;">
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:0;padding-top: 32px; text-align: center;">
                                <h1
                                        style="margin:0;padding:0;font-family:'Poppins', sans-serif;font-size: 30px; line-height: 36px; font-weight: 500;">
                        ...
                        <tr>
                            <td style="padding:0;padding-top: 16px; font-size: 17px; line-height: 24px; text-align: center">
                                <p style="margin:0;padding:0;font-family:'Poppins', sans-serif;">
                                    Thanks for signing up for our Newsletters on TradieReviews. We promise that we will keep
                                    you updated about our
                                    latest news.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 40px; font-size: 17px; line-height: 24px;">
                                <p
                                        style="margin:0;margin-bottom: 16px;padding:0;font-family:'Poppins', sans-serif; text-align: center;">
                                    Questions about setting up TradieReviews? Get in touch with us at <a
                                            href="mailto:info@tradiereviews.co">info@tradiereviews.co</a></p>
                                <p style="margin: 0;padding:0;font-family:'Poppins', sans-serif; text-align: center;">
                                    If you did not request this email, don’t worry – just ignore it.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-top: 78px; font-size: 17px; line-height: 24px;">
                                <p style="margin:0;padding:0;font-family:'Poppins', sans-serif; text-align: center;">Tailored
                                    to your needs by
                                    Tradie<span style="display: inline; color: #3962FA;">Reviews</span></p>
                                <p style="margin:0;padding:0;font-family:'Poppins', sans-serif; text-align: center;"><a
											...
											middle;">Homepage</a> <span style="display: inline; vertical-align: middle;">.</span>
                                    <a href="{{ $other_parameters['app_url'] }}/free-trial" style="margin-left: 12px; display: inline; vertical-align:
											middle;">Free Trial</a></p>
                            </td>
                        </tr>
                    </table>
                </td>
